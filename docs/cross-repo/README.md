...
Esta seccion agrupa documentacion que solo tiene sentido cuando se consideran
dos o mas repos o servicios juntos.

## Usar Esta Seccion Para

- mapas de dependencia
- mapas de handoff
- guias de deployment multi-repo
- playbooks de request cross-repo
- mapas de arquitectura que abarcan app, BFF e infra
