...
```powershell
npm.cmd run jira:mcp:doctor -- --request-id CR-SST-0038 --output-dir evidence/requests/CR-SST-0038 --mode read-only
```
...
```powershell
npm.cmd run jira:mcp:policy-check -- --request-id CR-SST-0038 --output-dir evidence/requests/CR-SST-0038 --expected-count 9
```
...
- Evidence: `evidence/requests/CR-SST-0038/jira-policy-check-summary.md`
...
Los warnings observados no fueron introducidos por CR-SST-0038:
