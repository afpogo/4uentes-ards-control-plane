# Payloads históricos aprobados para JIRA-SEC-PREPROD-02

> Snapshot del contenido efectivamente autorizado y enviado. Las referencias
> a `CR-SST-0204` se conservan porque forman parte del payload histórico, pero
> ese ID pertenece canónicamente al lifecycle de Bend. `CR-SST-0213` gobierna
> la reconciliación y no autoriza por sí solo una nueva escritura Jira.
