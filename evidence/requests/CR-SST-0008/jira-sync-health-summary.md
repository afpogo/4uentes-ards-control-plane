...
- Observation dir: `evidence/requests/CR-SST-0008`
- Reconciliation dir: `evidence/requests/CR-SST-0008`
...
- Proposal action: `continue-request`
- Health: `STATUS_SIGNAL_PENDING`
- External write required: no
- Reason: Observed Jira signal proposes action continue-request.
