...
visual_map:
  ...
  source_refs:
    - "requests/done/CR-CP-0020-promote-visual-documentation-as-code-policy-to-core.yaml"
    - "requests/planned/CR-CP-0006-roll-out-visual-documentation-policy-to-child-repos.yaml"
    - "requests/done/CR-SST-0186-adopt-visual-documentation-policy-in-4uentes-auth.yaml"
    - "requests/done/CR-SST-0187-adopt-visual-documentation-policy-in-sst-fend.yaml"
    - "requests/done/CR-SST-0188-adopt-visual-documentation-policy-in-sst-bend.yaml"
...
flowchart TD
    ...
    AUTH["CR-SST-0186<br/>4uentes-auth [validated]"]
    FEND["CR-SST-0187<br/>sst-fend [validated]"]
    BEND["CR-SST-0188<br/>sst-bend [validated]"]
...
Perfil y validator local validados
  ...
  -> CR-CP-0006 habilita lifecycles owner independientes [running]
     -> CR-SST-0186  4uentes-auth [adopted]
     -> CR-SST-0187  sst-fend [adopted]
     -> CR-SST-0188  sst-bend [adopted]
