...
Los warnings observados no fueron introducidos por CR-SST-0041:
...
CR-SST-0041 fue cerrado en `requests/done/` despues de definir el contrato.

No se ejecutaron:

- writes Jira;
- transiciones locales de `state/features`;
- cambios en repos funcionales.
