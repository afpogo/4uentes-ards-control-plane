...
OK: Dry-run evidence written: evidence/requests/CR-SST-0036/ticket-payload-dry-run.md
```
...
OK: Evidence written: evidence/requests/CR-SST-0036/jira-policy-check-summary.md
```
...
OK: Evidence written: evidence/requests/CR-SST-0036/jira-required-fields-summary.md
```
...
OK: Evidence written: evidence/requests/CR-SST-0036/duplicate-search-summary.md
```
...
OK: Evidence written: evidence/requests/CR-SST-0036/jira-reconciliation-summary.md
```
