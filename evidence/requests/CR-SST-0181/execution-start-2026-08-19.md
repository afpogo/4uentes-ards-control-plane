...
La implementación Auth permanece local. Antes del cierre se debe validar el
contrato de introspección desde `sst-bend`, publicar el PR draft owner y volver
a ejecutar el check completo del control plane. La reconciliación de índices
de una base existente y cualquier rollout pertenecen a un gate posterior.
